...
I should probably convert this to pytorch so that GPU inference can be done in windows. Or tflite for faster cpu in windows. And to test/do more in windows.
